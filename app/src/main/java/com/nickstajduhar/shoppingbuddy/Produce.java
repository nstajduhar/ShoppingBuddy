...
public class Produce {
    ...
    public Produce(String name, Double price, Double ppPound, String itemImg) {
        this.name = name;
        this.price = price;
    ...
    public Produce(int id, String name, Double price, Double ppPound, String itemImg) {
        this.name = name;
        this.price = price;
        this.ppPound = ppPound;
        this.itemImg = itemImg;
    ...
    public static final Parcelable.Creator<Produce> CREATOR = new Parcelable.Creator<Produce>() {
        @Override
