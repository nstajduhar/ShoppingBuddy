 ...
 * {@link BrowseView.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link BrowseView#newInstance} factory method to
 * create an instance of this fragment.
 */
public class BrowseView extends Fragment {
     ...
     */
    public static BrowseView newInstance(ArrayList<Item> list, int position) {
        BrowseView fragment = new BrowseView();
